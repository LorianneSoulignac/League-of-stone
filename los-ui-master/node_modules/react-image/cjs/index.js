...
function (_Component) {
  ...
  function Img(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "srcToArray", function (src) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "loadImg", function () {
      {
        _this.i = new Image();
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "unloadImg", function () {
